...
public class ScheduleMutation implements MutationPolicy {
	...
	public ScheduleMutation(JobSkillToWorkerMap jobSkillToWorkerMap, double mutationProbability, Jobs jobs) {
